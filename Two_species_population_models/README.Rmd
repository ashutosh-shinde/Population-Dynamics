...
source("LV_competition.R")
source("CR_competition.R")
source("Prey_predator_dynamics.R")
```
...
+:=================================+:===================+:===================+
| Complex with                     | **Stable Spiral**  | Asymptotically     |
| $\text{Re}(\lambda) < 0$         |                    | Stable             |
+----------------------------------+--------------------+--------------------+
| Complex with                     | **Unstable         | Unstable           |
| $\text{Re}(\lambda) > 0$         | Spiral**           |                    |
+----------------------------------+--------------------+--------------------+
| Complex with                     | **Center**         | Lyapunov Stable    |
| $\text{Re}(\lambda) = 0$         |                    |                    |
...
|                                  | fails)             |                    |
+----------------------------------+--------------------+--------------------+
| Real and both $\lambda < 0$      | **Stable Node**    | Asymptotically     |
|                                  |                    | Stable             |
+----------------------------------+--------------------+--------------------+
| Real and both $\lambda > 0$      | **Unstable Node**  | Unstable           |
+----------------------------------+--------------------+--------------------+
| Real with opposite signs         | **Saddle Point**   | Unstable           |
| $(\lambda_1 > 0, \lambda_2 < 0)$ |                    |                    |
+----------------------------------+--------------------+--------------------+
| At least one $\lambda = 0$       | **Non-hyperbolic** | Inconclusive\      |
|                                  |                    | Needs nonlinear    |
|                                  | (linearization     | terms              |
|                                  | fails;             |                    |
|                                  |                    |                    |
...
|                                  | take over)         |                    |
+----------------------------------+--------------------+--------------------+
| $\lambda_1 = \lambda_2 \not = 0$ | **Degenerate       | $\lambda < 0$ :    |
| and                              | node**             |                    |
|                                  |                    | :   Asymptotically |
| A is not diagonalizable.         |                    |     Stable         |
|                                  |                    |                    |
|                                  |                    | $\lambda > 0$ :    |
|                                  |                    |                    |
|                                  |                    | :   Unstable       |
+----------------------------------+--------------------+--------------------+
| $\lambda_1 = \lambda_2 \not = 0$ | Star node          | $\lambda < 0$ :    |
| and                              |                    |                    |
|                                  |                    | :   Asymptotically |
| A is diagonalizable.             |                    |     Stable         |
|                                  |                    |                    |
|                                  |                    | $\lambda > 0$ :    |
|                                  |                    |                    |
|                                  |                    | :   Unstable       |
...
| equilibrium  |                            |                        |
+:============:+:===========================+:=======================+
| $e_0$        | $r_1 \lt 0,\ r_2 \lt 0$    | Both species go        |
|              |                            | extinct                |
+--------------+----------------------------+------------------------+
| $e_1$        | $\alpha_{12} K_1 \gt K_2$  | Species 1 excludes     |
|              | and                        | Species 2              |
|              |                            |                        |
|              | $K_1 \gt \alpha_{21}K_2$   |                        |
+--------------+----------------------------+------------------------+
| $e_2$        | $K_2 \gt \alpha_{12} K_1$  | Species 2 excludes     |
|              | and                        | Species 1              |
|              |                            |                        |
|              | $\alpha_{21} K_2 \gt K_1$  |                        |
+--------------+----------------------------+------------------------+
| $e_3$        | $K_1 \gt \alpha_{21}K_2$   | Stable coexistence     |
|              | and                        |                        |
|              |                            |                        |
|              | $K_2 \gt \alpha_{12}K_1$   |                        |
+--------------+----------------------------+------------------------+
| $e_1,\ e_2$  | $\alpha_{21}K_2 \gt K_1$   | Bistability / Founder  |
|              | and                        | effect                 |
|              |                            |                        |
|              | $\alpha_{12}K_1 \gt K_2$   | (Initial conditions    |
...
```{r Phase_portrait_LV, fig.show="hold"}
...
```{R Phase_protrait_CR, fig.show="hold"}
#=====================================================================
param_list = list(
  # R1* = R2*
